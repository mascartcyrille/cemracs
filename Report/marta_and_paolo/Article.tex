\RequirePackage[l2tabu, orthodox]{nag} % individua comandi obsoleti e mi aiuta nella notazione

%\documentclass[a4paper,12pt,centertags]{amsart}
...
\usepackage[a4paper]{geometry}	% to adjust the margins of pages
...
\textbf{EXERCISE:}  remove the assumption of \todo{2} boundedness on $\alpha^{i, j}$. \\
...
We will here present a probabilistic argument for the blow-up, based on the proof presented by Carrilo, Perthame et al. in (?)\todo{mettere la bibliografia}
\begin{theorem}
