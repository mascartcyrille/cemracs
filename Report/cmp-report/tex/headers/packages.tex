...
\usepackage[final]{graphicx}			% for inserting figures
...
\usepackage{ifthen}
\usepackage{tikz}
\usetikzlibrary{math,intersections,through,backgrounds,patterns,calc,decorations.pathreplacing,arrows,decorations.markings}
\usepackage{caption}
